    ...
    return (
      <div className="container">
        <div className="banner-img-container">
          <img
            src="../static/images/Snow-covered-mountain-banner.jpg"
        ...
        <div className="sponsers-container row w-100">
          <img
            src="https://via.placeholder.com/2000x100/FFFFFF/000000/?text=Sponser Logos across"
            alt="Sponsers"
            className="sponser-banner"
          />
        </div>{" "}
        {/* end sponser container */}
        <div className="image-carousel-container">
          <div
            id="dealImagesIndicators"
            className="carousel slide"
            data-ride="carousel"
          >
            <ol className="carousel-indicators">
              <li
                data-target="#dealImagesIndicators"
                data-slide-to="0"
                className="active"
              ></li>
        ...
        <div className="featured-products-container">
          ...
          >
            ...
            {/* end featured products item carousel */}
            <a
              className="carousel-control-prev featured-control-prev"
              href="#featuredProductsControls"
              role="button"
              data-slide="prev"
            >
              <span
            ...
            {/* end featured products prev button */}
            <a
              className="carousel-control-next featured-control-next"
              href="#featuredProductsControls"
              role="button"
              data-slide="next"
            >
            ...
            {/* end featured products next button */}
          </div>{" "}
        ...
        <div className="contact-carousel-container">
          <div
            id="carouselContactControls"
            className="carousel slide"
            data-ride="carousel"
          >
            <ol className="carousel-indicators">
              <li
                data-target="#carouselContactControls"
                data-slide-to="0"
                className="active"
              ></li>
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img
                  className="d-block w-100"
                  src="https://via.placeholder.com/800x200?text=First Slide"
                  alt="First slide"
                />
              </div>
              <div className="carousel-item">
