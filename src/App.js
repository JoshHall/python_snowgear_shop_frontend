  ...
  addItem = id => {
    ...
    for (let i in this.state.products) {
      if (this.state.products[i].product_id === id) {
        ...
        let sizes = document.getElementById(
          "sizes" + this.state.products[i].product_id
        );
      ...
      <div className="App">
        ...
        <Switch>
          ...
          <Route
            ...
            path="/shop"
            render={() => (
              <Shop products={this.state.products} addItem={this.addItem} />
            )}
          />
          <Route
            exact
